package com.oscargomez.status_saver.Adapters;
...
import com.oscargomez.status_saver.Activities.MainActivity;
                ...
                holder.downloadID.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        try {
                            ...
                            //MainActivity.ShowAd();//Hope you want to call the ads from here.
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
                        ...
                        Toast.makeText(context, "Saved Story", Toast.LENGTH_LONG).show();
                    }
                });
                break;
            case NATIVE_EXPRESS_AD_VIEW_TYPE:
